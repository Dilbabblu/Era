...
@Injectable()
export class DealarrangementService {

    constructor(private http: HttpClient) { }
    getAllDealServices(): Observable<any> {
        return forkJoin(
            this.http.get(appSettings.apiUrl + '/rmanCurrencySearch?search=%25&size=10000').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanLookupsVSearch?search=lookupTypeName:ARRG_HIERARCHY,&size=10000').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanLookupsVSearch?search=lookupTypeName:SALES_LEVEL1,&size=10000').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanLookupsVSearch?search=lookupTypeName:SALES_LEVEL2,&size=10000').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanLookupsVSearch?search=lookupTypeName:SALES_LEVEL3,&size=10000').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanLookupsVSearch?search=lookupTypeName:SALES_LEVEL4,&size=10000').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanLookupsVSearch?search=lookupTypeName:ARRG_SOURCE,&size=10000').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanLookupsVSearch?search=lookupTypeName:ARRG_BASIS,&size=10000').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanUsersSearch?search=%25').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanCustomersSearch?search=%25').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanMasterArrangementsVSearch?search=%25').pipe(map((res: Response) => res), catchError(error => of(null))),

            this.http.get(appSettings.apiUrl + '/rmanLegalEntitiesSearch?search=%25').pipe(map((res: Response) => res), catchError(error => of(null)))
        )
    }
    getAllRmanDealArrangements(paginationOptions: any, rmanDealArrangementsSearchObject: any): Promise<any[]> {
        let serviceUrl = appSettings.apiUrl + '/rmanDealArrangementsSearch?';
        let searchString = '';
    ...
    saveRmanDealArrangements(rmanDealArrangements: any): Promise<any[]> {
        ...
        return this.http.post<any[]>(appSettings.apiUrl + '/saveArrangement', body, httpOptions).toPromise().then(data => {
            return data;
        });
    }
