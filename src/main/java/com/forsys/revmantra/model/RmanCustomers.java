...
import com.forsys.revmantra.listener.RmanCustomersListener;


@Entity
@EntityListeners(RmanCustomersListener.class)
@Table(name="RMAN_CUSTOMERS")
public class RmanCustomers {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "RMAN_CUSTOMERS_seq_gen")
	@SequenceGenerator(name = "RMAN_CUSTOMERS_seq_gen", sequenceName = "RMAN_CUSTOMERS_S", allocationSize=1)
    ...
    @Column(name="PRIMARY_SALESREP_NAME")
    ...
    public String getPersonPreviousLastName() { 
        return this.personPreviousLastName;
    }
    ...
    public String getOrigSystemReference() { 
        return this.origSystemReference;
    }
    ...
    public String getPrimarySalesrepName() { 
        return this.primarySalesrepName;
    }

    public void setPrimarySalesrepName(String primarySalesrepName) { 
        this.primarySalesrepName=primarySalesrepName;
    }
    ...
    public String getPersonAcademicTitle() { 
        return this.personAcademicTitle;
    }
