...
import com.forsys.revmantra.listener.RmanContTransToReleaseListener;

@Entity
@EntityListeners(RmanContTransToReleaseListener.class)
@Table(name = "RMAN_CONT_TRANS_TO_RELEASE")
@NamedStoredProcedureQuery(name = "rman_cont_insert_release_line_proc", procedureName = "RMAN_DEAL_UTIL_PKG.INSERT_RELEASE_LINE", parameters = {
...
public class RmanContTransToRelease {
	 ...
	 * 
	 * @JoinColumn(name="ARRANGEMENT_STATUS",insertable = false, updatable =
	 * false ) private RmanLookupsV rmanLookupsV;
	 * 
	 * @OneToOne(fetch = FetchType.EAGER)
	 * 
	 * @JoinColumn(name="RELEASE_TYPE",insertable = false, updatable = false )
	 * private RmanLookupsV rmanLookupsV1;
	 * 
	 * @OneToOne(fetch = FetchType.EAGER)
	 * 
	 * @JoinColumn(name="REV_ACCOUNTANT_ID",insertable = false, updatable =
	 * false ) private RmanUsers rmanUsers;
	 * 
	 * @OneToOne(fetch = FetchType.EAGER)
	 * 
...
/**	@OneToOne(fetch = FetchType.LAZY,optional = true)
	...
	@OneToOne(fetch=FetchType.LAZY,optional=true)
	@JoinColumn(name="RULE_HEADER_ID",insertable=false,updatable=false,referencedColumnName="RULE_HEADER_ID")
	private RmanContHeader rmanContHeader;
	...
	public String getRuleName(){
		return rmanContHeader!=null ? rmanContHeader.getRuleName() : "";
	}
...
/**	public RmanContLinkTemplateV2 getRmanContLinktemplateV2() {
	 ...
	 * 
	 * public RmanUsers getRmanUsers() { return rmanUsers; }
	 * 
	 * public void setRmanUsers(RmanUsers rmanUsers) { this.rmanUsers=rmanUsers;
	 * }
	 * 
	 * public RmanUsers getRmanUsers1() { return rmanUsers1; }
	 * 
	 * public void setRmanUsers1(RmanUsers rmanUsers1) {
	 * this.rmanUsers1=rmanUsers1; }
	 */
