...
import com.forsys.revmantra.listener.RmanDealArrangementsListener;

@Entity
@EntityListeners(RmanDealArrangementsListener.class)
@Table(name = "RMAN_DEAL_ARRANGEMENTS")
public class RmanDealArrangements {
	...
	@SequenceGenerator(name = "RMAN_DEAL_ARRANGEMENTS_seq_gen", sequenceName = "RMAN_DEAL_ARRANGEMENT_S", allocationSize=1)
	 ...
	 * 
	 * @JoinColumn(name="DEAL_ARRANGEMENT_STATUS",insertable = false, updatable
	 * = false ) private RmanLookupsV rmanLookupsV;
	 * 
	 * @OneToOne(fetch = FetchType.EAGER)
	 * 
	 * @JoinColumn(name="DEAL_ARRANGEMENT_BASIS",insertable = false, updatable =
