...
export class RmanOpenDealArrangementsLabels {
    ...
    constructor() {
        ...
        this.fieldLabels["endCustomerNumber"] = "END CUSTOMER NUMBER";
        ...
        this.fieldLabels["salesNodeLevel4"] = "Deal Closed Flag";
        ...
        this.fieldLabels["dealAgreementName"] = "Deal Arrangement Name";
        this.fieldLabels["attribute19"] = "ATTRIBUTE19";
        this.fieldLabels["poNumber"] = "PO Number";
    }
