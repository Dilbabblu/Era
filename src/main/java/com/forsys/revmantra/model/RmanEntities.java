...
import com.forsys.revmantra.listener.RmanEntitiesListener;


@Entity
@EntityListeners(RmanEntitiesListener.class)
@Table(name="RMAN_ENTITIES")
public class RmanEntities {
    ...
    @Id
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="RMAN_ENTITIES_seq_gen")
    @SequenceGenerator(name="RMAN_ENTITIES_seq_gen", sequenceName="RMAN_ENTITY_S", allocationSize=1)
    ...
    @Column(name="POST_BOOKING")
    private String postBooking;
    ...
    public String getPostBooking() { 
        return this.postBooking;
    }

    public void setPostBooking(String postBooking) { 
